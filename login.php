  ...
  <body>
    <section class="vh-100">
      <div class="container-fluid h-custom">
        <div class="row d-flex justify-content-center align-items-center h-100 mt-6">
          ...
          <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            ...
            <form  method="post" action="verifylogin.php">
              ...
              <div class="form-outline mb-4">
                <input type="text" id="userNameConn" name="mailconnect" class="form-control form-control-lg"
                  placeholder="Nom d'utilisateur" />
              </div>
    
              <!-- Password input -->
              <div class="form-outline mb-3">
                <input type="password" id="PasswordConn" name="mdpconnect" class="form-control form-control-lg"
