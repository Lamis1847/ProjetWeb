            ...
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-4.6 px-4">
                    ...
                    <div class="row row-content">
                        <form class="col-6" id="inserUserForm" enctype="multipart/form-data" method="post" <?php echo "action= 'insertTask.php?Id=" . $getid . " ' "; ?>>
                        <?php } ?>     
                            <div class="form-row" id="kanbanTitleRow">
                            ...
                            <div class="form-row" id="titlerow">
                                <div class="form-group col-md-6">
                                    <label for="tastTitle">Titre de Tâche</label>
                                    <input type="text" class="form-control" id="tastTitle" placeholder="Nom" name="taskTitle">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="affectation">Affectation</label>
                                    <select onchange="showUserField();" id="affectation" class="form-control" name="status">
                                        <option value="affectee">Affectée</option>
                                        <option selected value="non affectee">Non Affectée</option>
                                    </select>
                                </div>
                            </div>
                            <div id="divUserTask">
                                <div class="form-row">
                                    ...
                                    <input type="date" id="limitDate" class="form-control" name="dateLimite">
                                </div>
                                    <div class="col-md-2 mb-3 align-self-end">
                                        <button type="button" class="btn btn-outline-dark" id="addUserTask" onclick=""><span data-feather="plus-circle"></span></button>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="descriptionForTask">Description</label>
                                    <textarea class="form-control" id="descriptionForKTask" rows="3" name="description"></textarea>
                                </div>
                            </div>
